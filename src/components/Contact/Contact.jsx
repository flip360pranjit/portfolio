  ...
  return (
    <div className="min-h-[50vh] bg-gradient-to-r from-actionTo to-actionFrom flex justify-center items-center text-[#fff] p-[10%]">
      <div className="flex flex-col items-center">
        <h3 className="font-exo font-semibold text-3xl text-center">
          Let's get in touch
        </h3>
        <p className="font-nunito text-xl mt-5 max-w-[80%] text-center">
        ...
        <div className="bg-[#fff] p-0.5 mt-12 rounded-full font-exo">
          <button className="transition ease-in-out delay-150 flex items-center gap-2 bg-[#6c17e1] px-10 py-3 rounded-full hover:bg-[#fff] hover:text-[#6c17e1] duration-50">
